...
--filter-udp=19294-19344,50000-50100 --filter-l7=discord,stun,unknown --dpi-desync=fake --dpi-desync-any-protocol=1 --dpi-desync-fake-discord="%~dp0files\quic_initial_www_google_com.bin" --dpi-desync-fake-discord="%~dp0files\ACTIVE_DISCORD_UDP.bin" --dpi-desync-fake-stun="%~dp0files\ACTIVE_DISCORD_UDP.bin" --dpi-desync-fake-unknown-udp="%~dp0files\quic_initial_www_google_com.bin" --dpi-desync-fake-unknown-udp="%~dp0files\ACTIVE_DISCORD_UDP.bin" --dpi-desync-repeats=4 --dpi-desync-cutoff=n4 --new ^
