...
set "file3=preset_general[ALT2].bat"
set "file4=service_create[ALT2].bat"
...
call :ReplaceInFile "%file3%" "%searchText%" "%replaceText%"
call :ReplaceInFile "%file4%" "%searchText%" "%replaceText%"
