...
--filter-udp=19294-19344,50000-50100 --filter-l7=discord,stun --dpi-desync=fake --dpi-desync-fake-discord="%~dp0files\stun.bin" --dpi-desync-fake-discord="%~dp0files\ACTIVE_DISCORD_UDP.bin" --dpi-desync-fake-stun="%~dp0files\ACTIVE_DISCORD_UDP.bin" --dpi-desync-repeats=3 --new ^
...
--filter-tcp=80,443 --hostlist="%~dp0files\list-general.txt" --hostlist-exclude="%~dp0files\list-exclude.txt" --ipset-exclude="%~dp0files\ipset-exclude.txt" --dpi-desync=fake,multisplit --dpi-desync-split-seqovl=664 --dpi-desync-split-pos=1 --dpi-desync-fooling=ts --dpi-desync-repeats=8 --dpi-desync-split-seqovl-pattern="%~dp0files\tls_clienthello_max_ru.bin" --dpi-desync-fake-tls="%~dp0files\stun.bin" --dpi-desync-fake-tls="%~dp0files\tls_clienthello_max_ru.bin" --dpi-desync-fake-http="%~dp0files\tls_clienthello_max_ru.bin" --new ^
...
--filter-tcp=80,443,8443 --ipset="%~dp0files\ipset-general.txt" --hostlist-exclude="%~dp0files\list-exclude.txt" --ipset-exclude="%~dp0files\ipset-exclude.txt" --dpi-desync=fake,multisplit --dpi-desync-split-seqovl=664 --dpi-desync-split-pos=1 --dpi-desync-fooling=ts --dpi-desync-repeats=8 --dpi-desync-split-seqovl-pattern="%~dp0files\tls_clienthello_max_ru.bin" --dpi-desync-fake-tls="%~dp0files\stun.bin" --dpi-desync-fake-tls="%~dp0files\tls_clienthello_max_ru.bin" --dpi-desync-fake-http="%~dp0files\tls_clienthello_max_ru.bin" --new ^
--filter-tcp=%GameFilterTCP% --ipset="%~dp0files\ipset-general.txt" --ipset-exclude="%~dp0files\ipset-exclude.txt" --dpi-desync=fake,multisplit --dpi-desync-any-protocol=1 --dpi-desync-cutoff=n4 --dpi-desync-split-seqovl=664 --dpi-desync-split-pos=1 --dpi-desync-fooling=ts --dpi-desync-repeats=8 --dpi-desync-split-seqovl-pattern="%~dp0files\tls_clienthello_max_ru.bin" --dpi-desync-fake-tls="%~dp0files\stun.bin" --dpi-desync-fake-tls="%~dp0files\tls_clienthello_max_ru.bin" --dpi-desync-fake-http="%~dp0files\tls_clienthello_max_ru.bin" --dpi-desync-fake-unknown="%~dp0files\stun.bin" --dpi-desync-fake-unknown="%~dp0files\tls_clienthello_max_ru.bin" --new ^
