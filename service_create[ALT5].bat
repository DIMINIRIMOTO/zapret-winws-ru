...
set ARGS=^
--wf-tcp=443,%GameFilter% --wf-udp=443,50000-50099,%GameFilter% ^
...
--filter-l3=ipv4 --filter-tcp=443,%GameFilter% --hostlist-exclude="%~dp0files\list-exclude.txt" --ipset-exclude="%~dp0files\ipset-exclude.txt" --dpi-desync=syndata,multidisorder --new ^
