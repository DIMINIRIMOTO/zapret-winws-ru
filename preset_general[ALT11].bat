...
--filter-tcp=80,443,%GameFilter% --ipset="%~dp0files\ipset-general.txt" --hostlist-exclude="%~dp0files\list-exclude.txt" --ipset-exclude="%~dp0files\ipset-exclude.txt" --dpi-desync=fake,multisplit --dpi-desync-split-seqovl=664 --dpi-desync-split-pos=1 --dpi-desync-fooling=ts --dpi-desync-repeats=8 --dpi-desync-split-seqovl-pattern="%~dp0files\tls_clienthello_max_ru.bin" --dpi-desync-fake-tls="%~dp0files\stun.bin" --dpi-desync-fake-tls="%~dp0files\tls_clienthello_max_ru.bin" --dpi-desync-fake-http="%~dp0files\tls_clienthello_max_ru.bin" --new ^
