...
* preset_general*.bat - Запуск приложения.
* service_create*.bat - Установка через запуск службой.
* universal.bat - Основной менеджер для работы с приложением. 

## Исполнямые файлы нужно запускать от имени Администратора, кроме universal.bat
