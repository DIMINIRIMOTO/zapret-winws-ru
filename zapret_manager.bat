...
echo 5. Hosts update (recommended)
echo 6. Restore hosts update
echo 7. Zapret diagnostics
echo 8. Zapret service info (debug)
echo 9. Discord cache cleaner (all)
echo 10. Exit
echo ==========================================
...
if "%menu_choice%"=="5" goto hosts_run
if "%menu_choice%"=="6" goto hosts_undo
if "%menu_choice%"=="7" goto tcp_diagnostics
if "%menu_choice%"=="8" goto service_info
if "%menu_choice%"=="9" goto discord_cache
