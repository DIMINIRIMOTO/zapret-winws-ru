...
--filter-tcp=443 --hostlist="%~dp0files\list-general.txt" --dpi-desync=fake,split --dpi-desync-autottl=2 --dpi-desync-repeats=6 --dpi-desync-fooling=badseq --dpi-desync-fake-tls="%~dp0files\tls_clienthello_www_google_com.bin" --new ^
