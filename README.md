...
* (ENABLE) - Работает со всеми адрессами которые указаны в файле приложения.
* (DISABLE) - Отключает любую фильтрацию адрессов.
* (EMPTY) - Работает со всеми адрессами проходящие через наш трафик, но не уверен что оно вобще работает.

# Гайд как использовать Айпсет Фильтрацию (NEW) [видео]([1](https://drive.google.com/file/d/1qf8jKcYtYOGCpV5IhCcf63TewhUnDlMN/view?usp=sharing))
