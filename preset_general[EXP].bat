...
--filter-udp=19294-19344,50000-50100 --filter-l7=discord,stun,unknown --dpi-desync=fake --dpi-desync-fake-discord="%~dp0files\quic_initial_www_google_com.bin" --dpi-desync-fake-discord="%~dp0files\ACTIVE_DISCORD_UDP.bin" --dpi-desync-fake-stun="%~dp0files\ACTIVE_DISCORD_UDP.bin" --dpi-desync-fake-unknown-udp="%~dp0files\quic_initial_www_google_com.bin" --dpi-desync-fake-unknown-udp="%~dp0files\ACTIVE_DISCORD_UDP.bin" --dpi-desync-repeats=4 --new ^
...
--filter-udp=%GameFilterUDP% --ipset="%~dp0files\ipset-general.txt" --ipset-exclude="%~dp0files\ipset-exclude.txt" --dpi-desync=fake --dpi-desync-repeats=5 --dpi-desync-any-protocol=1 --dpi-desync-fake-unknown-udp="%~dp0files\quic_initial_4pda.to.bin" --dpi-desync-fake-unknown-udp="%~dp0files\ACTIVE_GAME_UDP.bin" --dpi-desync-cutoff=n4
