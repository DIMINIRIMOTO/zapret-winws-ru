...
--filter-udp=19294-19344,50000-50100 --filter-l7=discord,stun --dpi-desync=fake --dpi-desync-fake-discord="%~dp0files\stun.bin" --dpi-desync-fake-discord="%~dp0files\quic_initial_dbankcloud_ru.bin" --dpi-desync-fake-stun="%~dp0files\quic_initial_dbankcloud_ru.bin" --dpi-desync-repeats=3 --new ^
